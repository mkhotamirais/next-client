...
export default function Landing1() {
  ...
  return (
    <main
      ...
      style={{
        background:
          "linear-gradient(rgba(0,0,0,.4), rgba(0,0,0,.4)), url('https://images.pexels.com/photos/100582/pexels-photo-100582.jpeg?_gl=1*1nhzb3*_ga*MjA4NTYyMzgwNy4xNzUwMjIyMDg5*_ga_8JE65Q40S6*czE3NTAyMjIwODkkbzEkZzEkdDE3NTAyMjIwOTkkajUwJGwwJGgw') center/cover no-repeat",
      }}
